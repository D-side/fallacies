...
### Аппеляция к неизвестному авторитету
...
### Аппеляция к последствиям убеждения
...
> \'Конечно, гомосексуальность неестественна. Вы же не видите спаривания однополых животных.\'
...
### Аппеляция к принятию желаемого за действительное
...
Попытка спасти важное убеждение неоднократно пересматривая аргумент для объяснения проблем.
...
### Заблуждение о скользком спуске
...
> \'Изучение вреда для здоровья, причиняемого сотовыми телефонами, привлекло внимание операторов сотовой связи, поэтому этому исследованию нельзя доверять.\'
